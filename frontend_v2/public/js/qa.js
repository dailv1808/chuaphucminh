    ...
    return {
      ...
      autoSaveEditModal: _.debounce(async function() {
        ...
        try {
          ...
          const response = await fetch(getApiUrl(`/api/questions/${this.currentQuestion.id}/`), {
            method: 'PUT',
            headers: { 
              'Authorization': `Bearer ${token}`, 
              'Content-Type': 'application/json' 
      ...
      fetchQuestions: function() {
        ...
        fetch(getApiUrl(`/api/questions/?${params.toString()}`), {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        })
      ...
      //   try {
      //     const response = await fetch(getApiUrl(`/api/questions/${this.selectedQuestion.id}/`), {
      //       method: 'PATCH',
      //       headers: { 
      //         'Authorization': `Bearer ${token}`,
      //         'Content-Type': 'application/json'
